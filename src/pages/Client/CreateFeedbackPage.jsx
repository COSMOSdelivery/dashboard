...
const CreateFeedback = () => {
  ...
  const handleCreateFeedback = async () => {
    try {
      ...
      if (!feedbackData.titre || !feedbackData.commentaire || !selectedOrder) {
      ...
      if (response.status === 201) {
        setSuccessMessage("Feedback créé avec succès !");
        setSelectedOrder(null);
        setFeedbackData({ titre: "", commentaire: "" });
      } else {
        throw new Error("Échec de la création du feedback");
      }
    } catch (error) {
      setError(error.message);
    }
  ...
  return (
    <div className="flex-1 overflow-auto relative z-10">
      <Header title="Créer un Feedback" />
      ...
      <Card className="shadow-sm border-gray-100">
        ...
        <CardContent className="px-6">
          <div className="grid md:grid-cols-2 gap-6">
                  ...
                  {orders.map((order) => (
                    <div
                      ...
                      className={`p-3 rounded-lg border transition-all hover:bg-gray-50 ${
                        selectedOrder === order.code_a_barre
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <Checkbox
                          checked={selectedOrder === order.code_a_barre}
            ...
            {/* Selected Order and Feedback Form Section */}
            <div>
              <h2 className="text-sm uppercase tracking-wide text-gray-500 font-medium mb-3">
                Feedback pour la Commande Sélectionnée
              </h2>
                    ...
                    <div className="p-3">
                      <div className="py-2">
                        <div className="flex justify-between items-center">
                          <div>
                            <span className="font-medium text-gray-800">#{selectedOrder}</span>
                            <p className="text-sm text-gray-600">
                              {orders.find((o) => o.code_a_barre === selectedOrder)?.designation}
                            </p>
                          </div>
                          <Button
                            variant="ghost"
                      ...
                      <div className="pt-3 space-y-4">
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setFeedbackData({ ...feedbackData, titre: e.target.value })
                            }
                            className="mt-1 p-2 border border-gray-200 rounded w-full text-sm focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            onChange={(e) =>
                              setFeedbackData({ ...feedbackData, commentaire: e.target.value })
                            }
                            className="mt-1 p-2 border border-gray-200 rounded w-full text-sm focus:ring-blue-500 focus:border-blue-500"
              ...
              <div className="mt-6">
                <Button
                  ...
                  disabled={!selectedOrder || !feedbackData.titre || !feedbackData.commentaire}
