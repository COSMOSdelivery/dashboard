...
import { Package, Phone, MapPin, CreditCard } from 'lucide-react';

const PaymentOrderList = ({ orders, onSelect, selectedAgent, getStatusColor, stats, loading }) => {
  return (
      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
            ...
            Commandes Disponibles pour Paiement
          </h2>
          ...
          <div className="flex items-center justify-center h-full text-gray-500">
            <div className="text-center">
              ...
              <p className="text-sm mt-1">
                {selectedAgent ? 'Aucune commande correspondant au livreur' : 'Sélectionnez un livreur'}
              </p>
            </div>
          </div>
        ) : (
